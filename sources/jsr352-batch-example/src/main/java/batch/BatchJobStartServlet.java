...
public class BatchJobStartServlet extends HttpServlet {
	...
	private void writeLink(OperatorAction action, String text, Long executionId, HttpServletRequest req,
			HttpServletResponse res) throws IOException {

		PrintWriter out = res.getWriter();
		StringBuilder sb = new StringBuilder();
		sb.append("<a href=\"").append(req.getContextPath()).append(SERVLET_MAPPING).append("?action=")
				.append(action.name());
